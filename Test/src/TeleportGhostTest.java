...
public class TeleportGhostTest {

    private TeleportGhost telepghost;
    ...
    public void iniMap(GameElement[][] omap){
        ...
        omap[1][8] = new Coin(10); omap[1][9] = telepghost;
    ...
    @BeforeEach
    public void setUp() {
        telepghost = new TeleportGhost(10,9,1);
        iniMap(omap);
    }
    @Test
    public void testMoveDelay(){
        assertEquals(10,telepghost.getMoveDelay(),"Fool Ghost move delay incorrect");
    }

    @Test
    public void testCollidePacman(){
        Pacman pac = new Pacman(3,7);
        telepghost.collide(pac);
    ...
    public void testMove(){
        int x = telepghost.getX();
        int y = telepghost.getY();
        int[] check = {x,y};
        int[] coor = {x,y};
        telepghost.move(omap,coor);
        assertNotEquals(check,coor,"Teleport ghost did not move");
    }
}
