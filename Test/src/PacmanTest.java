...
public class PacmanTest {
    ...
    public void iniMap(GameElement[][] omap){
        ...
        omap[6][4] = pacman;                omap[6][5] = new Coin(10);
    ...
    @BeforeEach
    public void setUp(){
        pacman = new Pacman(4, 6);
        foolghost = new FoolGhost(1,2,7);
        iniMap(omap);
    }
    @Test
    public void testPacmanDefaultDirection() {
        assertEquals(68,pacman.getDirection(),"Pacman default direction wrong");
    }
    @Test
    public void testPacmanChangeDirection() {
        pacman.setDirection(65);
        assertEquals(65,pacman.getDirection(),"Pacman direction wrong");
    }
    @Test
    public void testPacmanDefaultPoint() {
        assertEquals(0,pacman.getPoint(),"Pacman default point wrong");
    }
    @Test
    public void testPacmanChangePoint() {
        pacman.addPoints(1000);
        assertEquals(1000,pacman.getPoint(),"Pacman point wrong");
    }
    @Test
    public void testPacmanCollideGhost() {
        pacman.collide(foolghost);
        assertFalse(pacman.isPacManAlive(),"Pacman collide ghost wrong");
    }
    ...
    public void testPacmanMove(){
        ...
        int y = pacman.getY();
        int[] coor = {x,y};
        pacman.move(omap,coor);
        assertEquals(y,coor[1],"Pacman move Y wrong");
        assertEquals(x+1,coor[0],"Pacman move X wrong");
    }
